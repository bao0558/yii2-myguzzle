<?php
     ...
     * @since 1.0.0-a
     */
    class MyGuzzle extends Component
    {
         ...
         * @return mixed
         */
        public function request( string $url = '' , string $method = 'POST' ,$async = false , ?array $data = null , ?array $before = null, ?array $header = null , ?array $middle = null )
        {
            //前置请求
            $this->getBefore( $before , $middle , $header );
            if ( $data ) {
         ...
         * @param array $middle
         */
        public function getBefore( ?array $before = null , ?array $middle = null , ?array $header = null)
        {
            //请求参数 需要在头之前
            $this->before( $before );
            //请求头
         ...
         * @return void|null
         */
        public function setMiddleware( ?array $middle = null )
        {
         ...
         * @param array $before
         */
        public function before( ?array $before = null )
        {
